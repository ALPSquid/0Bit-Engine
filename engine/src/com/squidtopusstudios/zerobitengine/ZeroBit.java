...
import com.squidtopusstudios.zerobitengine.coreDeprecated.Managers;
import com.squidtopusstudios.zerobitengine.utils.Logger;
import com.squidtopusstudios.zerobitengine.controllers.KeyboardController;
...
public final class ZeroBit {
    ...
    /** positioning for Box2D sprite bounds. See {@link com.squidtopusstudios.zerobitengine.entity.ZbeEntityB2D #setBoundsOrigin(BoundsOrigin)} **/
    public static enum BoundsOrigin {
        BOTTOM_LEFT, CENTER
    }

    /** Physics Types for Entities:
     *      NONE:       No Gravity applied
     *      PLATFORMER: Gravity applied
     */
    ...
    /**
     * Gets the main {@link com.squidtopusstudios.zerobitengine.ZerobitGame}
     * @return the active {@link com.squidtopusstudios.zerobitengine.ZerobitGame}
     */
    ...
    /**
     * Gets the active {@link com.squidtopusstudios.zerobitengine.World}
     * @return the active {@link com.squidtopusstudios.zerobitengine.World}
     */
    ...
    */
     ...
     */
    public static void setGlobalInputProcessor(KeyboardController inputProcessor) {
    ...
    /**
     * Get the global {@link com.squidtopusstudios.zerobitengine.controllers.KeyboardController} for the game. Use this to check for key presses on everything but stages
     * @return global registered {@link com.squidtopusstudios.zerobitengine.controllers.KeyboardController} for the game
     */
    public static KeyboardController input() {
        return (KeyboardController)inputMultiplexer.getProcessors().get(0);
    }
